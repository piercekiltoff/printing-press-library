...
large datasets as it has no memory pressure.`,
  ...
  paperclip-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  paperclip-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  paperclip-pp-cli export <resource> --format jsonl | jq '.id'`,
