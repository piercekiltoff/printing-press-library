...
In local mode: searches locally synced data only.`,
  ...
  flightgoat-pp-cli search "error timeout"

  # Force local search only
  flightgoat-pp-cli search "payment failed" --data-source local

  # Search a specific resource type locally
  flightgoat-pp-cli search "critical" --type transactions --data-source local
