...
func newHistoryGetFlightCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:   "Get information for a historical flight",
		Example: "  flightgoat-pp-cli history get-flight example-value",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(c, flags, "history", path, map[string]string{
