...
native streaming instead of polling.`,
  ...
  pagliacci-pizza-pp-cli tail --interval 10s

  # Tail a specific resource
  pagliacci-pizza-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  pagliacci-pizza-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
