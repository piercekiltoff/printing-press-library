...
large datasets as it has no memory pressure.`,
  ...
  redfin-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  redfin-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  redfin-pp-cli export <resource> --format jsonl | jq '.id'`,
