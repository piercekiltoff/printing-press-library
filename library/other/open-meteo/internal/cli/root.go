...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: "Manage open-meteo resources via the open-meteo API",
		Long: `Manage open-meteo resources via the open-meteo API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'open-meteo-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
