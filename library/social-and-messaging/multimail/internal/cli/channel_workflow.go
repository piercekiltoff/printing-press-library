...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  multimail-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"account", "api-keys", "audit-log", "confirm", "contacts", "domains", "emails", "mailboxes", "multimail-export", "multimail-health", "operator", "oversight", "suppression", "usage", "webhook-deliveries", "webhooks", "well-known",  }
			totalSynced := 0
