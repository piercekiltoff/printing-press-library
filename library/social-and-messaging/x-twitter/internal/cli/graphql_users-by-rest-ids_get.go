...
func newGraphqlUsersByRestIdsGetCmd(flags *rootFlags) *cobra.Command {
	var flagVariables string
	var flagFeatures string

	cmd := &cobra.Command{
		Use:   "get",
		Short: "get users by rest ids",
		Example: "  x-twitter-pp-cli graphql users-by-rest-ids get",
		Annotations: map[string]string{"pp:endpoint": "users-by-rest-ids.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/graphql/{pathQueryId}/UsersByRestIds"
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "users-by-rest-ids", false, path, params, nil)
			if err != nil {
