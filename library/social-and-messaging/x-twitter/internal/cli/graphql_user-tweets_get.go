...
func newGraphqlUserTweetsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "get",
		Short: "get user tweets",
		Example: "  x-twitter-pp-cli graphql user-tweets get",
		Annotations: map[string]string{"pp:endpoint": "user-tweets.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/graphql/{pathQueryId}/UserTweets"
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "user-tweets", false, path, params, nil)
			if err != nil {
