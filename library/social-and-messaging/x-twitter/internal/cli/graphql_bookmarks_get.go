...
func newGraphqlBookmarksGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "get",
		Short: "get bookmarks",
		Example: "  x-twitter-pp-cli graphql bookmarks get",
		Annotations: map[string]string{"pp:endpoint": "bookmarks.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/graphql/{pathQueryId}/Bookmarks"
