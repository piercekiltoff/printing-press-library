...
func newGraphqlFollowersYouKnowGetCmd(flags *rootFlags) *cobra.Command {
	var flagVariables string
	var flagFeatures string

	cmd := &cobra.Command{
		Use:   "get",
		Short: "get followers you know",
		Example: "  x-twitter-pp-cli graphql followers-you-know get",
		Annotations: map[string]string{"pp:endpoint": "followers-you-know.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/graphql/{pathQueryId}/FollowersYouKnow"
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "followers-you-know", false, path, params, nil)
			if err != nil {
