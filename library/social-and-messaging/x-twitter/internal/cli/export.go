...
large datasets as it has no memory pressure.`,
  ...
  x-twitter-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  x-twitter-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  x-twitter-pp-cli export <resource> --format jsonl | jq '.id'`,
