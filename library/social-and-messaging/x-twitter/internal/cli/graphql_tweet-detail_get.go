...
func newGraphqlTweetDetailGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "get",
		Short: "get TweetDetail",
		Example: "  x-twitter-pp-cli graphql tweet-detail get",
		Annotations: map[string]string{"pp:endpoint": "tweet-detail.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/graphql/{pathQueryId}/TweetDetail"
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "tweet-detail", false, path, params, nil)
			if err != nil {
