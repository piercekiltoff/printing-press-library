...
func newGraphqlSearchTimelineGetCmd(flags *rootFlags) *cobra.Command {
	var flagVariables string
	var flagFeatures string

	cmd := &cobra.Command{
		Use:   "get",
		Short: "search tweet list. product:[Top, Latest, People, Photos, Videos]",
		Example: "  x-twitter-pp-cli graphql search-timeline get",
		Annotations: map[string]string{"pp:endpoint": "search-timeline.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/graphql/{pathQueryId}/SearchTimeline"
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "search-timeline", false, path, params, nil)
			if err != nil {
