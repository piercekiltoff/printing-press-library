...
func newGraphqlUserByScreenNameGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  x-twitter-pp-cli graphql user-by-screen-name get",
		Annotations: map[string]string{"pp:endpoint": "user-by-screen-name.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/graphql/{pathQueryId}/UserByScreenName"
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "user-by-screen-name", false, path, params, nil)
			if err != nil {
