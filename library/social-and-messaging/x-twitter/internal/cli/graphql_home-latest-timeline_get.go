...
func newGraphqlHomeLatestTimelineGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  x-twitter-pp-cli graphql home-latest-timeline get",
		Annotations: map[string]string{"pp:endpoint": "home-latest-timeline.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/graphql/{pathQueryId}/HomeLatestTimeline"
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "home-latest-timeline", false, path, params, nil)
			if err != nil {
