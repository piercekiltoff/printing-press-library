...
func newGraphqlFollowingGetCmd(flags *rootFlags) *cobra.Command {
	var flagVariables string
	var flagFeatures string

	cmd := &cobra.Command{
		Use:   "get",
		Short: "get user list of following",
		Example: "  x-twitter-pp-cli graphql following get",
		Annotations: map[string]string{"pp:endpoint": "following.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/graphql/{pathQueryId}/Following"
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "following", false, path, params, nil)
			if err != nil {
