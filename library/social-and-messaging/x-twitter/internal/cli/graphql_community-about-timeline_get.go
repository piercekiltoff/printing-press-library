...
func newGraphqlCommunityAboutTimelineGetCmd(flags *rootFlags) *cobra.Command {
	var flagVariables string
	var flagFeatures string

	cmd := &cobra.Command{
		Use:   "get",
		Short: "get about of community",
		Example: "  x-twitter-pp-cli graphql community-about-timeline get",
		Annotations: map[string]string{"pp:endpoint": "community-about-timeline.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/graphql/{pathQueryId}/CommunityAboutTimeline"
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "community-about-timeline", false, path, params, nil)
			if err != nil {
