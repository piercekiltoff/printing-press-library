...
func newGraphqlFollowersGetCmd(flags *rootFlags) *cobra.Command {
	var flagVariables string
	var flagFeatures string

	cmd := &cobra.Command{
		Use:   "get",
		Short: "get user list of followers",
		Example: "  x-twitter-pp-cli graphql followers get",
		Annotations: map[string]string{"pp:endpoint": "followers.get", "mcp:read-only": "true"},
