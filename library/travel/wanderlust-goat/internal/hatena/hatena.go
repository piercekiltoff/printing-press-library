// Package hatena is a Stage-2 stub source. Real implementation deferred per
...
const StubReason = "hatena.ne.jp blog search deferred (multiple subdomains, fragmented post structure)"
