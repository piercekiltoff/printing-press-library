// Package kakaomap is a Stage-2 stub source. Real implementation deferred per
...
const StubReason = "kakao map place search requires a registered app key; deferred until v2.x"
