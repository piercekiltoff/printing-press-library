// Package gamberorosso is a Stage-2 stub source. Real implementation deferred per
...
const StubReason = "Gambero Rosso paywalled detail pages; deferred"
