// Package observerfood is a Stage-2 stub source. Real implementation deferred per
...
const StubReason = "Observer Food Monthly is content-managed via The Guardian; deferred"
