// Package lafourchette is a Stage-2 stub source. Real implementation deferred per
...
const StubReason = "LaFourchette / TheFork search requires session cookie handshake; deferred"
