...
large datasets as it has no memory pressure.`,
  ...
  flightgoat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  flightgoat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  flightgoat-pp-cli export <resource> --format jsonl | jq '.id'`,
