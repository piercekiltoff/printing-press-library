...
but do not stop the import.`,
  ...
  flightgoat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  flightgoat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | flightgoat-pp-cli import <resource> --input -`,
