...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  flightgoat-pp-cli which "stale tickets"
  flightgoat-pp-cli which "bottleneck"
  flightgoat-pp-cli which --limit 1 "send message"
  flightgoat-pp-cli which                                # list the full capability index`,
