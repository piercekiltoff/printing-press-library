...
but do not stop the import.`,
  ...
  pagliacci-pizza-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pagliacci-pizza-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pagliacci-pizza-pp-cli import <resource> --input -`,
