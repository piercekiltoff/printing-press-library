...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/sales-and-crm/servicetitan-crm/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "servicetitan-crm-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
