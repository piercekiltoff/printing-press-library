...
but do not stop the import.`,
  ...
  servicetitan-memberships-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  servicetitan-memberships-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | servicetitan-memberships-pp-cli import <resource> --input -`,
