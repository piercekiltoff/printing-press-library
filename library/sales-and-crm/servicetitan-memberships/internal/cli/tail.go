...
native streaming instead of polling.`,
  ...
  servicetitan-memberships-pp-cli tail --interval 10s

  # Tail a specific resource
  servicetitan-memberships-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  servicetitan-memberships-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
