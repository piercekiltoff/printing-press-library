...
but do not stop the import.`,
  ...
  hubspot-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  hubspot-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | hubspot-pp-cli import <resource> --input -`,
