...
Data must be synced first with the sync command.`,
  ...
  hubspot-pp-cli analytics --type deals

  # Group by a field
  hubspot-pp-cli analytics --type deals --group-by dealstage

  # Top 10 most frequent values
  hubspot-pp-cli analytics --type contacts --group-by company --limit 10 --json`,
