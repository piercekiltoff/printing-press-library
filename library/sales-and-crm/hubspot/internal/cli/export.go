...
large datasets as it has no memory pressure.`,
  ...
  hubspot-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  hubspot-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  hubspot-pp-cli export <resource> --format jsonl | jq '.id'`,
