...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  amazon-sp-api-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  amazon-sp-api-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  amazon-sp-api-pp-cli workflow status

  # Show status as JSON
  amazon-sp-api-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("amazon-sp-api-pp-cli")
			}
