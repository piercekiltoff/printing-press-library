...
native streaming instead of polling.`,
  ...
  amazon-sp-api-pp-cli tail --interval 10s

  # Tail a specific resource
  amazon-sp-api-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  amazon-sp-api-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
