...
Exit codes & warnings:
  ...
  amazon-sp-api-pp-cli sync

  # Sync specific resources only
  amazon-sp-api-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  amazon-sp-api-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  amazon-sp-api-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  amazon-sp-api-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  amazon-sp-api-pp-cli sync --latest-only`,
