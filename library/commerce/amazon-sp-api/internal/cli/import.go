...
but do not stop the import.`,
  ...
  amazon-sp-api-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  amazon-sp-api-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | amazon-sp-api-pp-cli import <resource> --input -`,
