...
func Execute() error {
	...
	rootCmd := &cobra.Command{
		Use:   "dominos-pp-cli",
		Short: "Order pizza, browse menus, optimize deals, and track delivery from the terminal",
		Long: `Order pizza, browse menus, optimize deals, and track delivery from Domino's via the terminal.

Backed by a local SQLite store that powers offline menu search, named order templates,
cross-store price comparison, deal optimization, menu-change tracking, and order analytics
that no other Domino's tool offers.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newOrderBulkCmd(&flags))
