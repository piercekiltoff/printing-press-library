...
large datasets as it has no memory pressure.`,
  ...
  dominos-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  dominos-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  dominos-pp-cli export <resource> --format jsonl | jq '.id'`,
