...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/productivity/outlook-calendar/internal/oauth"
...
`, "\n"),
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if clientID == "" {
				clientID = os.Getenv("OUTLOOK_CALENDAR_CLIENT_ID")
			}
	...
	cmd.Flags().StringVar(&scopes, "scopes", "", "Space- or comma-separated OAuth scopes (default: Calendars.ReadWrite User.Read offline_access)")
