...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://studio-api-prod.suno.com/api/clips/parent",
		EntryCount:    27,
		APIEntryCount: 27,
		...
		CandidateCommands: []string{
			"create_check — Derived from observed POST /api/c/check traffic.",
			"create_feed — Derived from observed POST /api/feed/v3 traffic.",
			"create_v2_web — Derived from observed POST /api/generate/v2-web/ traffic.",
			"get_attribution — Derived from observed GET /api/clips/{uuid}/attribution traffic.",
			"get_comments — Derived from observed GET /api/gen/{uuid}/comments traffic.",
			"list_badge_count — Derived from observed GET /api/notification/v2/badge-count traffic.",
			"list_direct_children_count — Derived from observed GET /api/clips/direct_children_count traffic.",
			"list_forked_onboarding — Derived from observed GET /api/statsig/experiment/forked-onboarding traffic.",
		},
	}
}
