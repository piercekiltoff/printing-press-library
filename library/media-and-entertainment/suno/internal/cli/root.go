...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "suno-pp-cli",
		Short: `Every Suno feature, plus a local SQLite library, offline FTS5 search, MCP-native agent surface, and a single-binary Go install.`,
		Long: `Every Suno feature, plus a local SQLite library, offline FTS5 search, MCP-native agent surface, and a single-binary Go install.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	// PATCH: register local Suno transcendence commands not generated from the endpoint spec.
