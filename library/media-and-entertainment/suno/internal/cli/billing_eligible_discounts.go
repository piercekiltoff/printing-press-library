...
func newBillingEligibleDiscountsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "List discounts the account is eligible for",
		Example:     "  suno-pp-cli billing eligible-discounts",
		Annotations: map[string]string{"pp:endpoint": "billing.eligible_discounts", "pp:method": "GET", "pp:path": "/api/billing/eligible-discounts", "mcp:read-only": "true"},
