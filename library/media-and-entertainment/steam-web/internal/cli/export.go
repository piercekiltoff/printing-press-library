...
large datasets as it has no memory pressure.`,
  ...
  steam-web-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  steam-web-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  steam-web-pp-cli export <resource> --format jsonl | jq '.id'`,
